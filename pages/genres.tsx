      ...
      <ul className="grid h-full w-full grid-cols-7 grid-rows-3  gap-x-3 gap-y-5  p-3 dark:bg-indigo-950">
        {genres.map((genre) => (
          <li>
            <div
              key={genre.id}
              className="duration-400 grid h-44 cursor-pointer place-content-center rounded-lg border-2 border-blue-300 bg-sky-200 font-ubuntu text-lg transition-all hover:border-indigo-700 hover:text-2xl hover:font-bold dark:bg-indigo-900 dark:text-sky-400 "
              onClick={() => {
